      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all shadow-md active:scale-95 ${scrolled ? 'bg-[#25D366] hover:bg-[#128C7E] text-dark' : 'bg-primary-dark hover:bg-blue-800 text-dark'}`}
          >
            WhatsApp Kami
          </a>
        </div>
