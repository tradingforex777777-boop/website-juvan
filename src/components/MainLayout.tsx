           ...
           <div className="bg-primary-dark border border-white/5 p-10 rounded-3xl shadow-2xl flex flex-col h-full text-white">
            ...
            <div className="bg-primary-dark border border-white/5 p-10 rounded-3xl shadow-2xl flex flex-col h-full text-white">
             ...
             <a 
               ...
               target="_blank"
               rel="noreferrer"
               className="w-full flex justify-between items-center py-4 px-6 bg-white text-primary-dark rounded-2xl hover:bg-[#25D366] text-white transition-all group shadow-lg shadow-blue-900/20"
             >
