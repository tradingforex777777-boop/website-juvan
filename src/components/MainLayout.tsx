          ...
          <div className="bg-primary-dark rounded-3xl p-8 md:p-16 border border-white/5 shadow-2xl text-white">
            ...
            <div className="max-w-6xl mx-8 px-2 mb-24 p-8 md:p-8">
              <div className="grid grid-cols-1 md:grid-cols-5 gap-6">  
                ...
                <div className="bg-primary-dark p-6 rounded-2xl shadow-xl border border-white/5 group overflow-hidden relative h-50">
                  <div className="absolute top-4 right-4 w-24 h-24 bg-blue-400/10 rounded-bl-full -mr-6 -mt-6 transition-transform group-hover:scale-150 duration-500"></div>
