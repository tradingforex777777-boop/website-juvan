  ...
  return (
    <div className="pt-0 pb-24 bg-primary-light">
      ...
      <section className="py-24 px-6 bg-primary-light">
        ...
        <div className="absolute px-20 top-0 right-20 w-50 h-50 bg-blue-400/10 rounded-bl-full -mr-6 -mt-6 transition-transform group-hover:scale-150 duration-500"></div>
