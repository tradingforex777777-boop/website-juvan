...
const Home = () => {
  ...
  const heroImages = [
    ...
    "https://images.unsplash.com/photo-1581595221475-1678a3d540cc?auto=format&fit=crop&q=80&w=2070",
      ...
      <section className="px-6 mb-24">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Galeri Produk</h2>
      ...
      <section className="px-6 space-y-12 mb-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
           ...
           <div className="bg-primary-dark border border-white/5 p-10 rounded-3xl shadow-2xl flex flex-col h-full text-white">
            ...
            <div className="bg-primary-dark border border-white/5 p-10 rounded-3xl shadow-2xl flex flex-col h-full text-white">
              <div className="mb-8">
                 <img src="https://katalog.inaproc.id/images/logo-katalog.svg" alt="Inaproc Logo" className="h-12 w-auto mb-4 brightness-0 invert" />
