      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all shadow-md active:scale-95 ${scrolled ? 'bg-[#25D366] hover:bg-[#128C7E] text-white' : 'bg-primary-dark hover:bg-[#25D366] text-white'}`}
          >
            WhatsApp Kami
          </a>
        </div>
    ...
    <div className="pt-0 bg-sky-50">
      ...
      <section className="py-24 px-6 bg-sky-50">
        <div className="max-w-7xl mx-auto mb-16 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4 tracking-tight uppercase">Sejarah</h2>
